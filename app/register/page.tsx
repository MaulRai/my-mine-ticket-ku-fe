        ...
        <div className="w-full max-w-md">
          ...
          <div className="glass-effect p-8">
            <div className="mb-8 text-center">
              <h1 className="font-heading mb-2 text-4xl font-bold text-white">Create Account</h1>
            ...
            <div className="my-6 flex items-center">
              ...
              <span className="font-body px-4 text-sm text-white/40">or</span>
              <div className="flex-1 border-t border-white/10" />
            </div>
            ...
            <div className="space-y-3">
              <Button
                type="button"
                variant="outline"
                className="font-body w-full border-white/20 bg-white/5 text-white hover:bg-white/10"
              >
